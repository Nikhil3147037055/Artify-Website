...
<body>
    ...
    $query = "SELECT products.p_id, products.p_name, products.p_img, products.p_price, orders.product_qty, orders.status, orders.product_id, orders.user_id
              FROM products
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <img style="width:150px; height:100px;" src="../admin_panel/products/<?php echo $rows['p_img']; ?>" alt="">
                            </td>
                            ...
                            <form action="../website/code.php" method="POST">
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-success" type="submit" name="status_Update">
                                        Update Status
                                    </button>
                                </td>
                            </form>
