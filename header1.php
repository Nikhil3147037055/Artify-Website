...
?>
      ...
      <div class="main-panel">
        <div class="main-header">
          ...
          <!-- Navbar Header -->
          <nav
            class="navbar navbar-header navbar-header-transparent navbar-expand-lg border-bottom maa"
          >
            <div class="container-fluid maa">
              <nav
                  ...
                  <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li>
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="../website/logout.php">Logout</a>
                      </li>
                    </div>
                  </ul>
                </li>
